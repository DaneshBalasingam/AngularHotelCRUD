...
angular.module('myApp.hotels.directives',[]);
...
angular.module('myApp.images.controllers',[]);

angular.module('myApp.images.controllers').controller('UploadImageController', ['$scope', '$http', function($scope, $http) {
